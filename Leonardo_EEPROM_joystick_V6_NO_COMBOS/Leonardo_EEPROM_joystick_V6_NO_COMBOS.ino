...
#define TEKKEN_FILTER_VALUE 1L  //miliseconds to wait for button
#define DEBOUNCE_MS     15L
...
for (int i = 0; i < NUM_BUTTONS; i++)
  {
    if(button_map[i]->active) //if the button is active AND no combos are active.
    {
